...
def initVanna(vn):
    ...
    queries = [
        ...
        # REMOVED CONTAMINATED JOIN EXAMPLE - was causing flat RUL lines
    ...
    # CRITICAL: Add exact evaluation query patterns for time-series RUL
    vn.train(question="Retrieve the time in cycles and operational setting 1 from the FD001 test table for unit number 1 and plot its value vs time", 
    sql="SELECT time_in_cycles, operational_setting_1 FROM test_data WHERE dataset = 'FD001' AND unit_number = 1")
    vn.train(question="Retrieve the time in cycles, operational setting 1, and RUL from the FD001 test table for unit number 1", 
    sql="SELECT time_in_cycles, operational_setting_1, ((SELECT MAX(time_in_cycles) FROM test_data WHERE dataset = 'FD001' AND unit_number = 1) + (SELECT RUL FROM rul_data WHERE dataset = 'FD001' AND unit_number = 1) - time_in_cycles) AS RUL FROM test_data WHERE dataset = 'FD001' AND unit_number = 1")

    # CRITICAL: Add unit-specific calculated RUL training examples for chart queries - FIXED
    ...
    sql="SELECT time_in_cycles, sensor_measurement_1, sensor_measurement_2, sensor_measurement_3, sensor_measurement_4, sensor_measurement_5, sensor_measurement_6, sensor_measurement_7, sensor_measurement_8, sensor_measurement_9, sensor_measurement_10, sensor_measurement_11, sensor_measurement_12, sensor_measurement_13, sensor_measurement_14, sensor_measurement_15, sensor_measurement_16, sensor_measurement_17, sensor_measurement_18, sensor_measurement_19, sensor_measurement_20, sensor_measurement_21, ((SELECT MAX(time_in_cycles) FROM test_data WHERE dataset = 'FD001' AND unit_number = 24) + (SELECT RUL FROM rul_data WHERE dataset = 'FD001' AND unit_number = 24) - time_in_cycles) AS RUL FROM test_data WHERE dataset = 'FD001' AND unit_number = 24")
    
    vn.train(question="Get time cycles, sensor data and RUL for unit 50 from FD002 test dataset", 
    sql="SELECT time_in_cycles, sensor_measurement_1, sensor_measurement_2, sensor_measurement_3, sensor_measurement_4, sensor_measurement_5, sensor_measurement_6, sensor_measurement_7, sensor_measurement_8, sensor_measurement_9, sensor_measurement_10, sensor_measurement_11, sensor_measurement_12, sensor_measurement_13, sensor_measurement_14, sensor_measurement_15, sensor_measurement_16, sensor_measurement_17, sensor_measurement_18, sensor_measurement_19, sensor_measurement_20, sensor_measurement_21, ((SELECT MAX(time_in_cycles) FROM test_data WHERE dataset = 'FD002' AND unit_number = 50) + (SELECT RUL FROM rul_data WHERE dataset = 'FD002' AND unit_number = 50) - time_in_cycles) AS RUL FROM test_data WHERE dataset = 'FD002' AND unit_number = 50")
    
    vn.train(question="Retrieve all sensor measurements and RUL data for engine unit 30 from FD003", 
    sql="SELECT time_in_cycles, sensor_measurement_1, sensor_measurement_2, sensor_measurement_3, sensor_measurement_4, sensor_measurement_5, sensor_measurement_6, sensor_measurement_7, sensor_measurement_8, sensor_measurement_9, sensor_measurement_10, sensor_measurement_11, sensor_measurement_12, sensor_measurement_13, sensor_measurement_14, sensor_measurement_15, sensor_measurement_16, sensor_measurement_17, sensor_measurement_18, sensor_measurement_19, sensor_measurement_20, sensor_measurement_21, ((SELECT MAX(time_in_cycles) FROM test_data WHERE dataset = 'FD003' AND unit_number = 30) + (SELECT RUL FROM rul_data WHERE dataset = 'FD003' AND unit_number = 30) - time_in_cycles) AS RUL FROM test_data WHERE dataset = 'FD003' AND unit_number = 30")
    
    vn.train(question="Get time series data with RUL for unit 10 from FD004 test", 
    sql="SELECT time_in_cycles, sensor_measurement_1, sensor_measurement_2, sensor_measurement_3, sensor_measurement_4, sensor_measurement_5, sensor_measurement_6, sensor_measurement_7, sensor_measurement_8, sensor_measurement_9, sensor_measurement_10, sensor_measurement_11, sensor_measurement_12, sensor_measurement_13, sensor_measurement_14, sensor_measurement_15, sensor_measurement_16, sensor_measurement_17, sensor_measurement_18, sensor_measurement_19, sensor_measurement_20, sensor_measurement_21, ((SELECT MAX(time_in_cycles) FROM test_data WHERE dataset = 'FD004' AND unit_number = 10) + (SELECT RUL FROM rul_data WHERE dataset = 'FD004' AND unit_number = 10) - time_in_cycles) AS RUL FROM test_data WHERE dataset = 'FD004' AND unit_number = 10")
